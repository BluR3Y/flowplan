from .element_cls import ElementTransform
import pandas as pd
from ...exceptions import TransformError

# @ElementOperation.register_operation("cast")
# def _cast(series: pd.Series, *args, **kwargs) -> pd.Series:
...
@ElementTransform.register_operation("cast")
def _cast(series: pd.Series, to: str = None, policy: str = "fail", **kwargs) -> pd.Series:
    if to is None:
